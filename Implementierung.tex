...
\begin{itemize}
    ...
    \item \dwi{hier auch wieder: ALLE bilder referenzieren! und das bild Fall1Zustand zeigt nicht die ausführung des plugins, sondern nur den 'rest' des maven logs ab Tests. dies sollte hier aber sichtbar sein.}
...
\begin{itemize}
    ...
    \item \dwi{irgendwie fehlt hier jetzt noch ein screenshot der ausgefüllten missing-xml und einem dann erfolgreichen build.}
\end{itemize}

\dwi{ich finde die idee, hier mit konkreten fallbeispielen das verhalten zu zeigen, sehr gut!}