...
\dwi{ich glaub du musst IT nicht ausschreiben.}
...
\dwi{hier vielleicht auch "mindset" einwerfen - agil passiert ganz viel in den köpfen und die tools und techniken unterstützen das nur.}
...
Durch eine iterative Problemlösung und häufiges Feedback, können komplexe Geschäftsprozesse gelöst und damit die Zufriedenheit der Kunden \dwi{fortlaufend ..?} sichergestellt werden. 
...
\dwi{da gibt's doch bestimmt eine referenz auf das agile manifest? das sollte hier kommen.}
...
\dwi{der scope des satzes und der titel der referenz passen für mich erstmal nicht direkt zusammen - der wechsel zu agile wäre hier im scope, da ist 'ops' noch gar nicht drin. check nochmal was du hier sagen willst und wie diese referenz in deinen satzkontext passt.}
