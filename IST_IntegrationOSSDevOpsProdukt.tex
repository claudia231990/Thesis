...
\dwi{incidents werden nicht ausschließlich vom PO 'begonnen' - eine automatische meldung kann ihn zwar informieren, aber die aufgabe dahinter ist direkt klar ohne sein mitwirken.}
...
\dwi{welcher Bug? das schreibst hier zum ersten mal.}
...
\dwi{also wenn ich das kapitel so lese, dann fehlt mir die verbindung zwischen grafik und textfluss. ich würde
dazu kleine buchstaben/zahlen in den grafiken und eine auflistung der beschreibungen entlang der gleichen nummerierung für eingänglicher halten. so läufst du gefahr, das das wissen was du hast nicht richtig transportiert wird.}
...
Je nach Backlog Item entscheidet der Entwickler, welche Maßnahmen durchgeführt werden müssen und dokummentiert etwaige Fehler, die sich während der Entwicklung ergeben können. \dwi{dokummentiert .. hier sind noch einige rechtschreibfehler, da solltest nochmal prüfen. es gibt vllt für visual studio auch ein plugin was dir dabei hilft, z.B. https://marketplace.visualstudio.com/items?itemName=streetsidesoftware.code-spell-checker-german}
